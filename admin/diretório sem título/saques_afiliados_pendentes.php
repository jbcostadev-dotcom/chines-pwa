                        ...
                        <form id="formEditarSaque">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="statusSaque" name="statusSaque">
                                    <option value="apply">Pendente</option>
                                    <option value="success">Aprovado</option>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                btnsEdit.forEach(btn => {
                    btn.addEventListener('click', function () {
                        ...
                        // Ajusta select de status com base no status numérico
                        const statusSelect = document.getElementById('statusSaque');
                        if (statusSelect) {
                            let v = 'apply';
                            if (status === '1' || status === 1) v = 'success';
                            else if (status === '2' || status === 2) v = 'refuse';
                ...
                // Evento para atualizar o status
                document.getElementById('btnAtualizarSaque').addEventListener('click', function () {
                    ...
                    const statusSaque = document.getElementById('statusSaque').value; // apply/success/refuse
                    const xhr = new XMLHttpRequest();
                    ...
                    xhr.send(`id=${encodeURIComponent(saqueId)}&status=${encodeURIComponent(statusSaque)}`);
                });

...
class MultiGatewayProcessor {
    ...
    public function processGreePay($config, $transacao_id, $valor, $chavepix, $cpf, $nome_real) {
        ...
        $this->debug[] = "GreePay: Tipo: $pix_type, Chave: $pix_key_formatada";
        ...
        logAction('GreePay: Enviando requisição', [
        ...
        if ($success_http && isset($data['ok']) && $data['ok'] === true) {
            ...
            $this->debug[] = "GreePay: Saque criado - E2E: $e2e";
        }
        ...
        if ($eh_sucesso) {
            return [
                ...
                'e2e' => $e2e,
                'message' => 'Saque processado via GreePay',
                'response_data' => $data
            ];
        }
